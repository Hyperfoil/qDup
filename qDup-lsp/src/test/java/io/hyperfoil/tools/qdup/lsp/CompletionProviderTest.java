...
public class CompletionProviderTest {
    ...
    public void testTopLevelKeyCompletions() {
        ...
        List<CompletionItem> items = provider.completeForContext(YamlContext.TOP_LEVEL_KEY, doc, 0, null);
    ...
    public void testCommandKeyCompletions() {
        ...
        List<CompletionItem> items = provider.completeForContext(YamlContext.SCRIPT_COMMAND_KEY, doc, 2, null);
    ...
    public void testModifierKeyCompletions() {
        QDupDocument doc = new QDupDocument("test.yaml", "");
        List<CompletionItem> items = provider.completeForContext(YamlContext.COMMAND_MODIFIER_KEY, doc, 0, null);
    ...
    public void testHostConfigKeyCompletions() {
        QDupDocument doc = new QDupDocument("test.yaml", "");
        List<CompletionItem> items = provider.completeForContext(YamlContext.HOST_CONFIG_KEY, doc, 0, null);
    ...
    public void testRoleKeyCompletions() {
        QDupDocument doc = new QDupDocument("test.yaml", "");
        List<CompletionItem> items = provider.completeForContext(YamlContext.ROLE_KEY, doc, 0, null);
    ...
    public void testRoleScriptRefCompletions() {
        ...
        List<CompletionItem> items = provider.completeForContext(YamlContext.ROLE_SCRIPT_REF, doc, 8, null);
    ...
    public void testNoArgCommandInsertText() {
        QDupDocument doc = new QDupDocument("test.yaml", "");
        List<CompletionItem> items = provider.completeForContext(YamlContext.SCRIPT_COMMAND_KEY, doc, 0, null);
