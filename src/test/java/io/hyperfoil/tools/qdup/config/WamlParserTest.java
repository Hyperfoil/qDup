...
import static io.hyperfoil.tools.qdup.config.waml.WamlParser.CHILD;
import static io.hyperfoil.tools.qdup.config.waml.WamlParser.COMMENT;
import static io.hyperfoil.tools.qdup.config.waml.WamlParser.KEY;
import static io.hyperfoil.tools.qdup.config.waml.WamlParser.VALUE;
...
public class WamlParserTest extends SshTestBase {
            ...
            for(int i=0; i<json.size(); i++){
                ...
                yamlJson.forEach(obj->{
                    if(obj instanceof Json){
                        ...
                        fail("json entry was not a json "+obj);
                    }
                });
    ...
    public void charsOutsideInlineList (){
        ...
        fail("Yaml parser parsed incorrectly defined inline list");
